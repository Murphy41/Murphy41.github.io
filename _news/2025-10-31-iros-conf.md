...
description: >
  Highlights from IROS 2025 in Hangzhou, including my workshop presentation, the industry expo, and a short trip through Shanghai and Suzhou.
og_image: /assets/img/iros2025presentation.jpg
date: 2025-10-31
inline: false
related_posts: false
---
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="lazy" path="assets/img/shanghai_view.jpeg" title="Shanghai View" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="lazy" path="assets/img/suzhou_view.jpeg" title="Suzhou View" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
